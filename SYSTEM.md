...
- **2026-07-21 (h)** — Descarga de gráfico en **HD**: `pixelRatio` automático (según `getWidth/getHeight`) para que el PNG final sea ≥ ~1200×1200 px, con título/subtítulo escalados. Archivo `..._HD.png`.
